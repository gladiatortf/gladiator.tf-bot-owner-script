...
(function() {
    ...
    $('.price-boxes').append(
        `<a class="price-box" href="https://gladiator.tf/manage/my/item/${$('.stats-header-title').text().trim().replace("%", "%25")}" target="_blank" data-tip="top" data-original-title="Gladiator.tf">
